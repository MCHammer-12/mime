...
|---|--------|------|--------|----|
| 1 | done | [`[EG]` templates produce blank emails (3 flows, ~12 emails affected)](eg-templates-blank-emails.md) | `fix/code-parser-fidelity` | — |
...
| 4 | done | [Funnest PE Games email — socials block dropped](socials-block-missing.md) | `fix/socials-from-icon-src` | [#90](https://github.com/MCHammer-12/mime/pull/90) |
